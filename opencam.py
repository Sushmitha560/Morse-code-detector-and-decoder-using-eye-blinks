...
class Camera:
    ...
    def __init__(self):
        ...
        while True:
            ...
            #frame = cv.resize(frame,(1500,900),fx=0,fy=0, interpolation = cv.INTER_CUBIC)
            frame = cv.resize(frame,(1500,900),fx=0,fy=0, interpolation = cv.INTER_CUBIC)
            ...
            cv.putText(frame, "Blink count: " + str(blink_counter), (30, 50), font, 2, (0, 0, 255),5)
            cv.putText(frame, "EAR: " + str(blinking_ratio_rounded), (900, 50), font, 2, (0, 0, 255),5)
